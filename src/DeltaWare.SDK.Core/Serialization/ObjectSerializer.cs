...
using DeltaWare.SDK.Core.Serialization.Exceptions;
using DeltaWare.SDK.Core.Transformation;
using DeltaWare.SDK.Core.Transformation.Attributes;
using DeltaWare.SDK.Core.Transformation.Exceptions;
using System;
...
namespace DeltaWare.SDK.Core.Serialization
{
    /// <summary>
    ...
    public class ObjectSerializer : IObjectSerializer
    {
        ...
        public bool CanSerialize(Type type)
        {
            ...
            return Transformers.HasTransformer(type);
        }
        ...
        {
            return Transformers.HasTransformer<T>();
        }
